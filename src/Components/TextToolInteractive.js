// /src/Components/TextToolInteractive.js
...
 
						<Grid item xs={3}>
							...
							<Typography variant="caption" color="text.secondary" display="block">
								`addLineTool('Text')`. Click once on chart.
							</Typography>
						</Grid>
 
						<Grid item xs={3}>
							...
							<Typography variant="caption" color="text.secondary" display="block">
								`addLineTool('Text', exoticOptions)`.
							</Typography>
						</Grid>
 
						<Grid item xs={3}>
							...
							<Typography variant="caption" color="text.secondary" display="block">
								`addLineTool('Text')`. New tool created immediately, then click on chart.
							</Typography>
						</Grid>
 
					</Grid>
